				...
				<div class="col-lg-9 page-content col-thin-right">
							...
							<div class="content-footer text-start">
								@if (auth()->check())
									...
									@else
										...
										<a class="btn btn-success" target="_blank" href="https://wa.me/<?php echo ltrim( data_get($post, 'phone'), '+') ?>">
											<i class="fab fa-whatsapp"></i> <?php echo ltrim( data_get($post, 'phone'), '+') ?>
										</a>
									@endif
								@else
									<a href="tel:<?php echo  data_get($post, 'phone')  ?>" class="btn btn-warning">
									    <i class="fas fa-mobile-alt"></i> 
									    <?php echo ltrim( data_get($post, 'phone'), '+') ?>
									     </a>
					...
					<div class="card" style="margin-top:10px">
                      <div class="card-body">
                        ...
                        @include('post.commentsDisplay', ['comments' => $comments, 'post_id' =>  data_get($post, 'id') ])
                        ...
                        <form method="post" action="{{ route('comments.store') }}">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-success" value="{!! t('add_comment') !!}" />
                            </div>
                        </form>
                        @endif
                      </div>
