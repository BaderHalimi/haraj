...
$currentPage = (int)data_get($apiResult, 'meta.current_page', 0);
$lastPage = (int)data_get($apiResult, 'meta.last_page', 0);
		...
		<div class="container">
			<div class="row">
				...
				<div class="{{ $contentColSm }} page-content col-thin-left mb-4">
					...
					<div id="loading-indicator" class="text-center mt-3 mb-3" style="display: none;">
						<i class="fas fa-spinner fa-spin fa-2x"></i>
						<p class="mt-2">{{ t('جاري التحميل') }}</p>
					</div>
					
					<!-- Load More Button (will be shown via JavaScript) -->
					<div id="load-more-container" class="text-center mt-3 mb-3" style="display: none;">
						<button id="load-more-button" class="btn btn-primary">{{ t('مشاهدة المزيد') }}</button>
					</div>
					
					<!-- Keep the pagination for SEO but hide it with CSS -->
					<nav class="mt-3 mb-0 pagination-sm d-none" aria-label="">
...
@section('after_scripts')
	...
	<!-- Add the infinite scroll JavaScript file -->
