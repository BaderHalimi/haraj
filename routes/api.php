...
Route::middleware([CheckStatus::class])->group(function () {
       //yacoub search api 
  Route::get('/open-search', [OpenSearchController::class, 'search'])->withoutMiddleware('api');
Route::prefix('auth')
    ...
    Route::prefix('posts')
        ...
        ->group(function ($router) {
            ...
            $router->pattern('city_id', '[0-9]+'); // Add this line for city_id pattern
            $router->pattern('user_id', '[0-9]+'); // Add this line for user_id pattern
            ...
            // New route for getting posts by category_id
            Route::get('category/{category_id}', 'getByCategory')->name('posts.getByCategory');
            Route::get('city/{city_id}', 'getByCity')->name('posts.getByCity');
            Route::get('user/{user_id}', 'getByUser')->name('posts.getByUser');
    
            // New route for getting a limited number of posts
            Route::get('limited', 'getLimitedPosts')->name('posts.getLimitedPosts');
