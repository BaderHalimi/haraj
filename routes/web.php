...
Route::namespace('App\Http\Controllers\Web\Install')
	...
	->middleware(['web', 'no.http.cache', 'checkStatus'])
	->prefix('upgrade')
	->group(function () {
		Route::get('/', 'index');
		Route::post('run', 'run');
...
Route::namespace('App\Http\Controllers\Web\Install')
	...
	->middleware(['web', 'install.checker', 'no.http.cache', 'checkStatus'])
	->prefix('install')
	->group(function () {
		Route::get('/', 'starting');
...
Route::namespace('App\Http\Controllers\Admin')
	->middleware(['web', 'install.checker', 'checkStatus'])
...
Route::namespace('App\Http\Controllers\Web')
	...
	->group(function ($router) {
		...
		//test yacoub
		Route::get('/open-search-test', [App\Http\Controllers\Api\OpenSearchController::class, 'search']);
