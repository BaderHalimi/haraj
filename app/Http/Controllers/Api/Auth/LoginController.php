...
class LoginController extends BaseController
{
	 ...
	 * @bodyParam email string The user's email address or username (Required when 'auth_field' value is 'email'). Example: apitest@haraj.com
	 ...
	 * @bodyParam password string required The user's password. Example: ROCKQWASMA12#
